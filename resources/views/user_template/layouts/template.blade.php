...
<head>
    ...
    <!-- Title  -->
    <title>ECOMSINGLE - Ecommerce site</title>
    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <nav class="classy-navbar" id="essenceNav">
                <!-- Logo -->
                <a class="nav-brand" href="{{route('home')}}">ECOMSINGLE</a>
                <!-- Navbar Toggler -->
                            ...
                            <li><a href="#">Shop</a>
                                <div class="megamenu">
                                    <ul class="single-mega cn-col-4">
                                        ...
                                        <li><a href="{{asset('home/shop.html')}}">Dresses</a></li>
                                        <li><a href="{{asset('home/shop.html')}}">Blouses &amp; Shirts</a></li>
                                        <li><a href="{{asset('home/shop.html')}}">T-shirts</a></li>
                                        <li><a href="{{asset('home/shop.html')}}">Rompers</a></li>
                                        <li><a href="{{asset('home/shop.html')}}">Bras &amp; Panties</a></li>
                                    </ul>
                                    <ul class="single-mega cn-col-4">
                                        <li class="title">Men's Collection</li>
                                        <li><a href="{{asset('home/shop.html')}}">T-Shirts</a></li>
                                        <li><a href="{{asset('home/shop.html')}}">Polo</a></li>
                                        <li><a href="{{asset('home/shop.html')}}">Shirts</a></li>
                                        <li><a href="{{asset('home/shop.html')}}">Jackets</a></li>
                                        <li><a href="{{asset('home/shop.html')}}">Trench</a></li>
                                    </ul>
                                    <ul class="single-mega cn-col-4">
        ...
        <div class="cart-content d-flex">
            ...
            <div class="cart-amount-summary">
                ...
                <div class="checkout-btn mt-100">
                    <a href="{{asset('home/checkout.html')}}" class="btn essence-btn">check out</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="single_widget_area d-flex mb-30">
                        ...
                        <div class="footer_menu">
                            <ul>
                                <li><a href="{{asset('home/shop.html')}}">Shop</a></li>
                                <li><a href="{{asset('home/blog.html')}}">Blog</a></li>
                                <li><a href="{{asset('home/contact.html')}}">Contact</a></li>
                            </ul>
                        </div>
